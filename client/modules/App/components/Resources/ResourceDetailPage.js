...
import { styles } from './Resource.css'; //eslint-disable-line
      ...
      <section>
        ...
        <div className="map resource-detail-map">
          <iframe
            ...
            height="450"
            frameBorder="0"
            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAgPIVjOnke7nERCIiuF9oLzG2HRS1AwDs&amp;q=Shelter and Medical Organization+123 Main St+Seattle+,+WA+98101&amp;zoom=14"
          >
          </iframe>
        </div>
