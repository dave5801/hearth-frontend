...
import { styles } from './Header.css'; // eslint-disable-line
...
const Header = React.createClass({
  ...
  componentDidMount() {
    if (this.state.activeLink !== this.getActiveLink()) {
      this.setState({ activeLink: this.getActiveLink() }); // eslint-disable-line
    }
    /*eslint-disable */
    ...
    return (
      <div id="scrollRoot">
        <Navbar id="mainNav" fixedTop fluid className={this.state.activeLink === '/' ? '' : 'black-header'}>
          <Navbar.Header>
            <NavItem
              onSelect={this.goToRoute.bind(this, '/')}
          ...
          <Navbar.Collapse>
            <Nav className="ml-auto navbar-right">
              <NavItem
                onSelect={this.goToRoute.bind(this, '/login')}
                className={this.state.activeLink === '/login' ? 'active' : ''}
              >
                Login
              </NavItem>
              <NavItem
                onSelect={this.goToRoute.bind(this, '/resources')}
